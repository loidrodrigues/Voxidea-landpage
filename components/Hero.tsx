...
const MobileScreen: React.FC<{
  ...
  <div
    className={`relative w-[280px] h-[580px] rounded-[3rem] border-[8px] border-zinc-900 bg-[#F8F9FB] overflow-hidden shrink-0 transition-all duration-700 ${className}`}
  >
  ...
  return (
    <section className="relative pt-4 lg:pt-12 pb-20 lg:pb-32 overflow-hidden lg:overflow-visible">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full -z-10 pointer-events-none">
        <div
          className={`absolute top-1/4 left-1/2 -translate-x-1/2 w-[300px] md:w-[600px] h-[300px] md:h-[600px] blur-[80px] md:blur-[150px] rounded-full opacity-20 transition-colors duration-1000 ${
            tone === "bold" ? "bg-blue-600" : "bg-blue-400"
          }`}
        ></div>
      </div>
        ...
        <div className="flex-1 text-center lg:text-left space-y-8 z-20 px-4">
          <div className="space-y-6">
            ...
            >
              ...
              <span>Disponível apenas para Android</span>
            </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
            ...
            <div
              className={`flex items-center gap-2 text-sm font-medium ${
                tone === "bold" ? "text-zinc-500" : "text-slate-400"
              }`}
            >
              <i className="fa-solid fa-circle-check text-blue-500"></i>
              <span>
                {tone === "bold"
                  ? "Feedback real sem filtro"
            ...
            <MobileScreen>
              <div className="bg-[#2563EB] p-6 pt-12 text-white space-y-4">
                <div className="flex justify-between items-start">
                  ...
                  <div className="flex gap-2">
                    ...
                    <div className="w-9 h-9 rounded-full bg-slate-300 border border-white/40 overflow-hidden">
                      <img
                        src="https://api.dicebear.com/7.x/avataaars/svg?seed=Loid"
                        alt="Loid"
                      />
                    </div>
                  </div>
                ...
                <p className="text-[10px] opacity-80 leading-tight">
                  Sua opinião define quais projetos se tornam realidade.
                </p>
                <div className="flex gap-2">
                  <div className="bg-white/10 px-3 py-1.5 rounded-lg flex items-center gap-2 text-[10px] font-bold">
                    <i className="fa-solid fa-fire text-orange-400"></i> 12 em
                    alta
                  </div>
                  <div className="bg-white/10 px-3 py-1.5 rounded-lg flex items-center gap-2 text-[10px] font-bold">
                    <i className="fa-solid fa-sparkles text-yellow-400"></i> Top
                    Creators
                  </div>
                </div>
              </div>
              ...
              <div className="p-3 space-y-3">
                <div className="bg-white p-4 rounded-xl border border-slate-100 space-y-2 shadow-sm">
                  ...
                  <h4 className="text-sm font-bold text-slate-900 leading-tight">
                    Aplicativo para vender saco
                  </h4>
                  <p className="text-[10px] text-slate-500 leading-tight">
                    Esse app é muito bom para quem gosta de sustentabilidade...
                  </p>
                  <div className="flex justify-between items-center pt-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[9px] text-slate-500">
                        Loid Rodrigues Padre
                      </span>
                    </div>
                    <div className="flex gap-3 text-[10px] font-bold text-slate-400">
                      <span>
                        <i className="fa-solid fa-arrow-up text-orange-400"></i>{" "}
                        3
                      </span>
                      <span>
                        <i className="fa-solid fa-heart text-red-500"></i> 3
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="space-y-1">
                    <h3 className="text-2xl font-bold leading-tight">
                      Top 5 Ideias da Semana
                    </h3>
                    <p className="text-[10px] opacity-80 leading-tight">
                      Essas ideias serão comentadas na Review ao Vivo!
                    </p>
                  </div>
                </div>
              </div>
                ...
                {[
                  {
                    ...
                    title: "Aplicativo para vender saco",
                    votes: 3,
                    author: "Loid Rodrigues Padre",
                    icon: "fa-trophy text-yellow-500",
                  },
                  {
                    rank: "#2",
                    cat: "SUSTENTABILIDADE",
                    title: "uma strtup de reciclagem",
                    votes: 2,
                    author: "Pedro Panzo",
                    icon: "fa-medal text-slate-300",
                  },
                  {
                    rank: "#3",
                    cat: "TECNOLOGIA",
                    title: "Controle de orfanatos em Angola",
                    votes: 1,
                    author: "Bruno Eduardo Miala",
                    icon: "fa-award text-orange-400",
                  },
                ].map((item, i) => (
                  <div
                    key={i}
                    className="bg-white p-4 rounded-xl shadow-md border border-slate-100 flex gap-4 items-center"
                  >
                    ...
                    <div className="flex-1 space-y-1">
                      ...
                      <div className="flex items-center gap-3 pt-1">
                        <span className="text-[10px] font-bold text-orange-400">
                          <i className="fa-solid fa-arrow-up"></i> {item.votes}{" "}
                          votos
                        </span>
              ...
              <div className="bg-[#4F46E5] p-6 pt-12 text-white space-y-5">
                ...
                <div className="space-y-1">
                  <h4 className="text-2xl font-bold flex items-center gap-2">
                    <i className="fa-solid fa-sparkles text-yellow-300"></i> Top
                    Creators
                  </h4>
                  <p className="text-[10px] opacity-70">
                    Membros que mais contribuem.
                  </p>
                </div>
              </div>
              <div className="p-4 space-y-3 -mt-4">
                {[
                  ...
                  <div
                    key={i}
                    className="bg-white p-4 rounded-xl shadow-md border border-slate-100 flex items-center gap-4"
                  >
                    <span
                      className={`text-[11px] font-black ${user.color} w-6`}
                    >
                      {user.rank}
                    </span>
                    <div className="w-10 h-10 rounded-full bg-slate-200 border border-slate-200 overflow-hidden shrink-0">
                      <img
                        src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${user.img}`}
                        alt="user"
                      />
                    </div>
