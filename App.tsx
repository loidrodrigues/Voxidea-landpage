...
import AboutVoxidea from "./components/AboutVoxidea";
    ...
    >
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12 md:space-y-24 py-12">
        ...
        <div className="pt-12">
          <ProblemSolution
            tone={tone}
            content={{ problem: content.problem, solution: content.solution }}
          />
        </div>

        <DuelSection tone={tone} />

        <AboutVoxidea tone={tone} />

        <TargetAudience tone={tone} />
        ...
        <div className="text-center py-20 px-4">
          <p
            className={`text-xl md:text-3xl italic font-medium transition-all duration-500 ${
              tone === "bold"
                ? "font-bold-brand text-3xl md:text-5xl uppercase text-blue-500"
                : "text-slate-600"
            }`}
          >
            "{content.finalPhrase}"
