...
export const CONTENT_BOLD: LandingContent = {
  hero: {
    ...
    subheadline: "Coloque sua ideia à prova, receba feedback real e descubra se ela merece entrar no Top 5 da semana.",
  ...
  steps: [
    { number: "1", title: "Poste sua ideia", description: "Sem filtros. Sem floreios. Só a ideia, do jeito que ela é." },
    { number: "2", title: "Aguente o feedback", description: "Opiniões reais, comentários diretos e votos da comunidade." },
    { number: "3", title: "Veja se ela sobrevive", description: "Toda semana, só as melhores entram no Top 5." }
  ],
  mockupText: "Interface simples. Feedback em primeiro lugar. Ideias no centro de tudo.",
  testerCTA: {
...
export const CONTENT_PROFESSIONAL: LandingContent = {
  hero: {
    ...
    subheadline: "Publique sua ideia, receba opiniões construtivas e acompanhe as mais bem avaliadas da semana.",
  ...
  steps: [
    { number: "1", title: "Publicação da ideia", description: "Descreva sua proposta de forma clara e objetiva." },
    { number: "2", title: "Feedback da comunidade", description: "Receba comentários, sugestões e avaliações de outros participantes." },
    { number: "3", title: "Destaque semanal", description: "As ideias mais bem avaliadas ganham visibilidade no Top 5 da semana." }
  ],
  mockupText: "Interface intuitiva, foco em colaboração e melhoria contínua de ideias.",
  testerCTA: {
